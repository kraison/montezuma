  ...
  (:testfun test-compound-file-writer
   (let ((dir (fixture-var 'dir)))
     (let ((file1 (create-output dir "file1"))
       ...
       (write-int file1 20)
       (write-string-to-buffer file2 "this is file2")
       (close-down file1)
       (close-down file2))
  ...
  (:testfun test-compound-file-reader
   (let ((dir (fixture-var 'dir)))
     (let ((cfile (create-output dir "cfile")))
       (write-vint cfile 2)
       (write-long cfile 29)
       (write-string-to-buffer cfile "file1")
       (write-long cfile 33)
       (write-string-to-buffer cfile "file2")
       (write-int cfile 20)
       (write-string-to-buffer cfile "this is file 2")
       (close-down cfile))
  ...
  (:testfun test-compound-file-buffer
   (let ((dir (fixture-var 'dir))
	 ...
	 (write-int file1 (random 10000)))
       (write-string-to-buffer file2 big-string)
       (write-string-to-buffer file3 "this is file2")
       (close-down file1)
       (close-down file2)
       (close-down file3))
     (let ((cfile-writer (make-instance 'compound-file-writer
