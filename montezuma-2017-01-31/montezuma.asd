...
(defsystem #:montezuma
    ...
    :depends-on (#:cl-ppcre #:cl-fad #:babel #:trivial-garbage
                 #:split-sequence #:bt-semaphore #:local-time)
    :components
    ((:module "src"
      :components
      ((:file "package")
       (:module "util"
        :components ((:file "while")
                     ...
                     (:file "datetime" :depends-on ("utilities"))
                     (:file "levenshtein-distance")
                     (:file "character-entities"))
        :depends-on ("package"))
       (:module "store"
        :components ((:file "api")
       ...
       (:module "document"
        :components ((:file "field")
                     (:file "document"            :depends-on ("field")))
        :depends-on ("package"))
       (:module "analysis"
        :components ((:file "token")
                     ...
                     (:file "escape-filter"       :depends-on ("analyzers" "token-stream")))
       ...
       (:module "search"
        :components ((:file "api")
                     ...
                     (:file "field-sorted-hit-queue" :depends-on ("api"))
                     (:file "trivial-hit-queue" :depends-on ("api"))
                     (:file "explanation")
                     (:file "query" :depends-on ("api"))
                     (:file "term-query" :depends-on ("query"))
                     (:file "boolean-query" :depends-on ("query"))
                     (:file "date-term-query" :depends-on ("term-query"))
                     (:file "integer-term-query" :depends-on ("term-query"))
                     ...
                     (:file "boolean-scorer" :depends-on ("disjunction-sum-scorer" "conjunction-scorer"))
                     ...
                     (:file "typed-range-query" :depends-on ("query"))
                     (:file "integer-range-query" :depends-on ("typed-range-query"))
                     (:file "date-range-query" :depends-on ("typed-range-query"))
                     (:file "fuzzy-query" :depends-on ("query"))
                     (:file "top-docs" :depends-on ("api"))
                     (:file "sort-field" :depends-on ("api"))
                     (:file "sort" :depends-on ("api" "sort-field"))
                     (:file "index-searcher" :depends-on ("api" "sort"))
                     ...
                     (:file "match-all-query" :depends-on ("api"))
                     (:file "regular-expression-query" :depends-on ("match-all-query" "term-query"))
                     ;;(:file "regular-expression-term-enum")
                     (:file "regular-expression-term-query")
                     (:file "term-clause" :depends-on ("api"))
       ...
       (:module "hits"
        :components ((:file "expressions")
                     ...
                     (:file "hits" :depends-on ("expressions" "document-result")))
        :depends-on ("package" "index" "document" "search" "query-parser"))

       (:module "phrases"
        :components ((:file "identifier"))
        :depends-on ("package" "index" "document" "search" "query-parser" "hits"))

       (:module "abstracts"
        :components ((:file "abstractor"))
        :depends-on ("package" "index" "document" "search" "query-parser" "hits"))
       ...
       (:module "index"
        :components ((:file "api")
                     ...
                     (:file "segment-reader"      :depends-on ("index-reader" "index-filenames"))
...
(defparameter *test-directory-path* "/home/raison/work/montezuma/montezuma/montezuma-2017-01-31/tests/")
