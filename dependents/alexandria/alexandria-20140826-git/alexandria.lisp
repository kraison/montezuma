...
;(defmethod operation-done-p ((o test-op) (c (eql (asdf:find-system :alexandria))))
;  nil)

;(defmethod perform ((o test-op) (c (eql (asdf:find-system :alexandria))))
