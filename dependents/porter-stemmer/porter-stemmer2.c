...
/*  A direct encoding of the English (Porter2) stemmer defined at
    ...
    (Encoded by Martin Porter, improvements by Olly Betts.)
*/
/*
...
static int exception1(struct stemmer * z) {
    switch(z->b[0]) {
        case 's':
            ...
            if (equals(z, "\06" "singly")) { setto(z, "\05" "singl"); return TRUE; }
            return FALSE;
        case 'd':
